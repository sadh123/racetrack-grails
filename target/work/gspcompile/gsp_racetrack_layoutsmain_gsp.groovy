...
class gsp_racetrack_layoutsmain_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(8)
invokeTag('render','g',24,['template':("/layouts/header")],-1)
printHtmlPart(10)
...
printHtmlPart(13)
invokeTag('layoutResources','r',33,[:],-1)
printHtmlPart(8)
})
...
public static final long LAST_MODIFIED = 1548232413000L
