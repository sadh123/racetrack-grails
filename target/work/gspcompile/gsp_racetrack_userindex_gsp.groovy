...
class gsp_racetrack_userindex_gsp extends GroovyPage {
...
printHtmlPart(12)
invokeTag('sortableColumn','g',27,['property':("login"),'title':(message(code: 'user.login.label', default: 'Login'))],-1)
printHtmlPart(13)
...
public static final long LAST_MODIFIED = 1548142450000L
