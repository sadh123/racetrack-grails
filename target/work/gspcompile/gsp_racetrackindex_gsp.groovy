...
class gsp_racetrackindex_gsp extends GroovyPage {
...
invokeTag('link','g',92,['controller':(c.logicalPropertyName)],3)
printHtmlPart(8)
}
printHtmlPart(9)
})
...
public static final long LAST_MODIFIED = 1548322835000L
