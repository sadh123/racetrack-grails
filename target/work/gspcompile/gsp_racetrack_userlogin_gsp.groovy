...
class gsp_racetrack_userlogin_gsp extends GroovyPage {
...
invokeTag('form','g',44,['action':("authenticate"),'method':("post")],2)
printHtmlPart(10)
})
...
public static final long LAST_MODIFIED = 1548236358000L
