...
class gsp_racetrack_usershow_gsp extends GroovyPage {
...
printHtmlPart(14)
invokeTag('message','g',28,['code':("user.login.label"),'default':("Login")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(userInstance),'field':("login")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
